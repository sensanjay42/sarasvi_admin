...
@Component({
    selector: 'charterer-management',
    templateUrl: './charterer-management.component.html',
    styleUrls: ['./charterer-management.component.scss'],
...
export class ChartererManagementComponent implements OnInit, OnDestroy {
    ...
    chartererList(): void {
        try {
            this._userService.getChartererList()
            .pipe(first())
            .subscribe((res) => {
